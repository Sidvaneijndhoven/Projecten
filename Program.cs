...
// add a shop for fun where you can buy stuff with the balance
// Lamborghini, groceries, houses(villas, mansions)
// Motorbikes, Bmw s1000rr bmw m1000rr......
...
//string[] carBrands = { "1. Lamborghini", "2. Audi", "3. Volkswagen", "4. Ferarri" };
//string[] carInfo = { "1. Lamborghini is a good choice!", "2. Audi is a good choice!", "3. Volkswagen is a good choice!", "4. Ferarri is a good choice!" };
...
//if (int.TryParse(input, out choice) && choice >= 1 && choice <= carBrands.Length)
//{
//    Console.WriteLine($"You selected {carBrands[choice - 1]}");
//    Console.WriteLine();
//    Console.WriteLine($"{carInfo[choice - 1]}");
...
//else
//{
//    Console.WriteLine("Please enter a valid number of the list");
//}
